...
namespace Interface_Net4._5
{
    ...
    {
        private string PATH = @"D:\Proyecto_CHIRP_LED\Interface_NIDAQ\logs\signal.txt";
        private string TIME_REGISTER = @"D:\Proyecto_CHIRP_LED\Interface_NIDAQ\logs\time_registro.txt";
        private string PRETIME_REGISTER = @"D:\Proyecto_CHIRP_LED\Interface_NIDAQ\logs\pretime_registro.txt";
        private string VALS_REGISTER = @"D:\Proyecto_CHIRP_LED\Interface_NIDAQ\logs\vals_registro.txt";
        ...
        {
            //Está en bruto recién copiada. Hay que revisar la compatibilidad de las variables. 
